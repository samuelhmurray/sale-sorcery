    ...
    <div>
      {!project.userProjects.find((ep) => ep.userId === currentUser.id) && (
        <button
          ...
          class="mt-2 px-3 py-2 text-sm font-medium text-center text-text bg-claim rounded-lg hover:bg-hoverclaim focus:ring-4 focus:outline-none focus:ring-blue-300 "
        >
          Claim
        </button>
      )}
